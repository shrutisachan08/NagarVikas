  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      if (!kIsWeb && _selectedImage != null) {
        ...
        Fluttertoast.showToast(msg: "Web upload not supported in this demo. Store in Firebase or use base64.");
        imageUrl = "";
      }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: FadeInDown(
          ...
          child: const Text("Enter new issue", style: TextStyle(color: Colors.black, fontSize: 18, fontWeight: FontWeight.w900)),
        ),
        centerTitle: true,
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text("Please give accurate and correct information for a faster solution.", textAlign: TextAlign.center, style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700)),
            ZoomIn(
            ...
            DropdownButtonFormField<String>(
              ...
              items: _states.keys.map((state) => DropdownMenuItem(value: state, child: Text(state))).toList(),
            ...
            TextField(
              ...
              decoration: _inputDecoration().copyWith(
                ...
                suffixIcon: IconButton(icon: const Icon(Icons.my_location, color: Colors.black), onPressed: _getCurrentLocation),
              ),
            ),
            const SizedBox(height: 10),
            TextField(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: _selectedImage == null && _webImageBytes == null ? Border.all(color: Colors.red, width: 2) : null,
                ),
                child: Row(
            ...
            FadeInUp(
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  backgroundColor: _isUploading ? Colors.grey : (_selectedImage == null && _webImageBytes == null ? Colors.grey : Colors.black),
                  padding: const EdgeInsets.symmetric(horizontal: 100, vertical: 15),
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                ),
                onPressed: _selectedImage == null && _webImageBytes == null || _isUploading ? null : _submitForm,
                child: _isUploading
